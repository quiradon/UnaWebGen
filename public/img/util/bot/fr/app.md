**Améliorez vos sessions de RPG sur table**
...
![L'outil ultime pour les jeux de rôle sur table et les lancers de dés](https://rpg.arkanus.app/img/util/bot/fr/index.webp)
...
![Systèmes de lancer de dés](https://rpg.arkanus.app/img/util/bot/fr/dice.webp)
**Lancer les dés :**
...
![Systèmes RPG pris en charge et disponibles](https://rpg.arkanus.app/img/util/bot/fr/system.webp)
...
| ---------------------- | -------------------------------------------------- | -------- | ------------------- |
| **Donjons & Dragons (DnD)** | ![Logo Donjons et Dragons](https://rpg.arkanus.app/img/util/bot/icons/DnD.webp) | 🏗️ | `Médiéval`, `Fantastique` |
| **Ordem Paranormal** | ![Logo Ordem Paranormal](https://rpg.arkanus.app/img/util/bot/icons/Ordem.webp) | 🏗️ | « Moderne », « Enquête » |
| **Tormenta20** | ![Logo Tormenta RPG](https://rpg.arkanus.app/img/util/bot/icons/T20.webp) | 🏗️ | `Médiéval`, `Fantastique` |
| **Carbon2185** | ![Carbon2185 - RPG Cyberpunk](https://rpg.arkanus.app/img/util/bot/icons/Carbon.webp) | 🏗️ | « Cyberpunk », « Futuriste » |
| **Gaia : Le Prélude** | ![Gaia](https://rpg.arkanus.app/img/util/bot/icons/Gaia.webp) | 🏗️ | `Médiéval`, `Fantastique` |
| **3DET** | ![3DET - RPG fantastique](https://rpg.arkanus.app/img/util/bot/icons/3DET.webp) | 🏗️ | « Tout », « Dynamique » |
| **Pathfinder** | ![Pathfinder RPG](https://rpg.arkanus.app/img/util/bot/icons/Pathfinder.webp) | 🏗️ | `Fantastique` |
| **Sorciers et malédictions** | ![JdR Jujutsu Kaisen](https://rpg.arkanus.app/img/util/bot/icons/FeM.webp) | 🏗️ | `Jujutsu`, `École` |
...
![Améliorez votre communauté RPG](https://rpg.arkanus.app/img/util/bot/fr/comunity.webp)

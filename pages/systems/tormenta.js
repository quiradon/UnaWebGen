...
function page(idioma, rota) {
    const t = idioma
    const sistema = t.posts.sistemas[2]
    return `
<!DOCTYPE html>
<html lang="${t.lang}" data-bs-theme="dark">
${head(`${t.lang}${rota}`,`${t.system.default.title.replaceAll("%system%",sistema.card.title)}`,t.system.default.desc.replaceAll("%system%",sistema.card.title),"/static/img/banners/Tormenta20.webp")}
<body>
    ${nav(t, rota)}

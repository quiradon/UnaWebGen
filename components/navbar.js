...
function nav(t,rota) {
    ...
    <div class="container-fluid"><a class="navbar-brand d-flex align-items-center" href="/${t.lang}"><img class="img-fluid pe-1" src="/static/img/icons/logo.svg" alt="Mini Kraken Bot" width="30px" height="30px" /><span class="m-1">Mini Kraken</span></a><button class="navbar-toggler border-0" data-bs-toggle="collapse" data-bs-target="#navcol"><span class="visually-hidden"></span><span class="navbar-toggler-icon text-primary"></span></button>
        <div id="navcol" class="collapse navbar-collapse justify-content-between">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item"><a class="nav-link" href="/${t.lang}#premium"><svg class="m-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="1em" height="1em" fill="currentColor">
                ...
                <li class="nav-item dropdown"><a class="nav-link" aria-expanded="false" data-bs-toggle="dropdown" data-bs-auto-close="outside" href="#"><svg class="m-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="1em" height="1em" fill="currentColor">
                    ...
                    <div class="dropdown-menu shadow"><a class="dropdown-item d-flex" href="/${t.lang}/tools/names">
                            <div class="d-flex justify-content-center align-items-center mx-2"><svg class="bg-primary border rounded border-0 p-2 fs-2 me-2" xmlns="http://www.w3.org/2000/svg" viewBox="-32 0 512 512" width="1em" height="1em" fill="currentColor">
                        ...
                        </a><a class="dropdown-item d-flex" href="/${t.lang}/tools/baralho.html">
                            <div class="d-flex justify-content-center align-items-center mx-2"><svg class="bg-primary border rounded border-0 p-2 fs-2 me-2" xmlns="http://www.w3.org/2000/svg" viewBox="25 0 640 512" width="1em" height="1em" fill="currentColor">
                        ...
                        </a><a class="dropdown-item d-flex" href="/${t.lang}/tools/tarot.html">
                            <div class="d-flex justify-content-center align-items-center mx-2"><svg class="bg-primary border rounded border-0 p-2 fs-2 me-2" xmlns="http://www.w3.org/2000/svg" viewBox="-50 0 512 512" width="1em" height="1em" fill="currentColor">
                ...
                <li class="nav-item dropdown"><a class="nav-link" aria-expanded="false" data-bs-toggle="dropdown" data-bs-auto-close="outside" href="#"><svg class="m-1" xmlns="http://www.w3.org/2000/svg" viewBox="-32 0 512 512" width="1em" height="1em" fill="currentColor">
                        ...
                        </svg>${t.nav.docs.title}<svg class="mb-2" xmlns="http://www.w3.org/2000/svg" viewBox="-96 0 512 512" width="1em" height="1em" fill="currentColor">
                            <path d="M182.6 470.6c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-9.2-9.2-11.9-22.9-6.9-34.9s16.6-19.8 29.6-19.8H288c12.9 0 24.6 7.8 29.6 19.8s2.2 25.7-6.9 34.9l-128 128z"></path>
                        </svg></a>
                    <div class="dropdown-menu shadow"><a class="dropdown-item d-flex justify-content-sm-start" href="/${t.lang}/posts/dices.html">
                        ...
                        </a><a class="dropdown-item d-flex justify-content-sm-start" href="/${t.lang}/posts/comands.html">
                            <div class="d-flex justify-content-center align-items-center"><svg class="bg-primary border rounded border-0 p-2 fs-2 me-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 -64 640 640" width="1em" height="1em" fill="currentColor">
                        ...
                        <div class="dropdown-divider"></div><a class="dropdown-item d-flex justify-content-sm-start" href="/${t.lang}/posts/changelog.html">
                            <div class="d-flex justify-content-center align-items-center"><svg class="bg-primary border rounded border-0 p-2 fs-2 me-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="1em" height="1em" fill="currentColor">
            ...
            <ul class="navbar-nav ms-auto">
                <li class="nav-item dropdown"><a class="dropdown-toggle nav-link me-1" aria-expanded="false" data-bs-toggle="dropdown" href="#">${t.nav.lang.title}<svg class="ms-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="1em" height="1em" fill="currentColor">
                    ...
                    <a class="dropdown-item" href="${rota}" rel="alternate"><img class="img-fluid m-1 me-2" src="/static/img/flags/en.svg" width="25px" />English</a>
...
function footer(t) {
    ...
    <div class="container py-4 py-lg-5">
        ...
        <div class="d-flex justify-content-between align-items-center pt-3">
            <p class="text-muted mb-0">Copyright © 2023 Arkanus</p>
            <ul class="list-inline mb-0">
                <li class="list-inline-item"><a href="https://twitter.com/MiniKrakenBOT"><svg class="text-primary" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="1em" height="1em" fill="currentColor">
                            <path d="M389.2 48h70.6L305.6 224.2 487 464H345L233.7 318.6 106.5 464H35.8L200.7 275.5 26.8 48H172.4L272.9 180.9 389.2 48zM364.4 421.8h39.1L151.1 88h-42L364.4 421.8z"></path>
                        </svg></a></li>
                <li class="list-inline-item"><a href="https://www.tiktok.com/@minikrakenbot"><svg class="text-primary" xmlns="http://www.w3.org/2000/svg" viewBox="-32 0 512 512" width="1em" height="1em" fill="currentColor">
                            <path d="M448,209.91a210.06,210.06,0,0,1-122.77-39.25V349.38A162.55,162.55,0,1,1,185,188.31V278.2a74.62,74.62,0,1,0,52.23,71.18V0l88,0a121.18,121.18,0,0,0,1.86,22.17h0A122.18,122.18,0,0,0,381,102.39a121.43,121.43,0,0,0,67,20.14Z"></path>
                        </svg></a></li>
                <li class="list-inline-item"><a href="https://www.instagram.com/una_rpg/"><svg class="text-primary" xmlns="http://www.w3.org/2000/svg" viewBox="-32 0 512 512" width="1em" height="1em" fill="currentColor">

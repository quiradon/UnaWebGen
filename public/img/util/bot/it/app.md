**Migliora le tue sessioni di gioco di ruolo da tavolo**
...
![Lo strumento definitivo per i giochi di ruolo da tavolo e il lancio di dadi](https://rpg.arkanus.app/img/util/bot/it/index.webp)
...
![Sistemi RPG supportati e disponibili](https://rpg.arkanus.app/img/util/bot/it/system.webp)
...
| ---------------------- | -------------------------------------------------- | -------- | ------------------- |
| **Dungeons & Dragons (DnD)** | ![Logo di Dungeons and Dragons](https://rpg.arkanus.app/img/util/bot/icons/DnD.webp) | 🏗️ | `Medievale`, `Fantasy` |
| **Ordem Paranormal** | ![Logo paranormale di Ordem](https://rpg.arkanus.app/img/util/bot/icons/Ordem.webp) | 🏗️ | `Moderno`, `Investigativo` |
| **Tormenta20** | ![Logo Tormenta RPG](https://rpg.arkanus.app/img/util/bot/icons/T20.webp) | 🏗️ | `Medievale`, `Fantasy` |
| **Carbon2185** | ![Carbon2185 - Cyberpunk RPG](https://rpg.arkanus.app/img/util/bot/icons/Carbon.webp) | 🏗️ | `Cyberpunk`, `Futuristico` |
| **Gaia: Il Preludio** | ![Gaia](https://rpg.arkanus.app/img/util/bot/icons/Gaia.webp) | 🏗️ | `Medievale`, `Fantasy` |
| **3DET** | ![3DET - Gioco di ruolo fantasy](https://rpg.arkanus.app/img/util/bot/icons/3DET.webp) | 🏗️ | `Tutto`, `Dinamico` |
| **Pathfinder** | ![Pathfinder RPG](https://rpg.arkanus.app/img/util/bot/icons/Pathfinder.webp) | 🏗️ | `Fantasia` |
| **Maghi e Maledizioni** | ![Jujutsu Kaisen RPG](https://rpg.arkanus.app/img/util/bot/icons/FeM.webp) | 🏗️ | `Jujutsu`, `Scuola` |
...
![Migliora la tua community di giochi di ruolo](https://rpg.arkanus.app/img/util/bot/it/comunity.webp)

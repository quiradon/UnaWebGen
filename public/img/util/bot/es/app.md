...
![La herramienta definitiva para juegos de rol de mesa y lanzamiento de dados](https://rpg.arkanus.app/img/util/bot/es/index.webp)
...
![Sistemas de lanzamiento de dados](https://rpg.arkanus.app/img/util/bot/es/dice.webp)
...
![Sistemas RPG compatibles y disponibles](https://rpg.arkanus.app/img/util/bot/es/system.webp)
...
| ---------------------- | -------------------------------------------------- | -------- | ------------------- |
| **Dragones y Mazmorras (DnD)** | ![Logotipo de Dragones y Mazmorras](https://rpg.arkanus.app/img/util/bot/icons/DnD.webp) | 🏗️ | `Medieval`, `Fantasía` |
| **Ordem Paranormal** | ![Logotipo de Ordem Paranormal](https://rpg.arkanus.app/img/util/bot/icons/Ordem.webp) | 🏗️ | `Moderno`, `Investigación` |
| **Tormenta20** | ![Logotipo de Tormenta RPG](https://rpg.arkanus.app/img/util/bot/icons/T20.webp) | 🏗️ | `Medieval`, `Fantasía` |
| **Carbono2185** | ![Carbon2185 - Juego de rol Cyberpunk](https://rpg.arkanus.app/img/util/bot/icons/Carbon.webp) | 🏗️ | `Cyberpunk`, `Futurista` |
| **Gaia: El Preludio** | ![Gaia](https://rpg.arkanus.app/img/util/bot/icons/Gaia.webp) | 🏗️ | `Medieval`, `Fantasía` |
| **3DET** | ![3DET - RPG de fantasía](https://rpg.arkanus.app/img/util/bot/icons/3DET.webp) | 🏗️ | `Todo`, `Dinámico` |
| **Pathfinder** | ![Pathfinder RPG](https://rpg.arkanus.app/img/util/bot/icons/Pathfinder.webp) | 🏗️ | `Fantasía` |
| **Feiticeiros & Maldições** | ![Jujutsu Kaisen RPG](https://rpg.arkanus.app/img/util/bot/icons/FeM.webp) | 🏗️ | `Jujutsu`, `Escuela` |
...
![Mejora tu comunidad RPG](https://rpg.arkanus.app/img/util/bot/es/comunity.webp)

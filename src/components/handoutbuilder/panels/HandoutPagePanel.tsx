...
export function HandoutPagePanel(props: HandoutPagePanelProps) {
  const { doc, setDoc, recordColor, colorHistory, snapEnabled, setSnapEnabled, snapTolerance, setSnapTolerance } = props;
